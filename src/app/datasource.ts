...
export let sampleData: Object[] = [
    ...
    { taskID: 2, taskName: 'Plan timeline', taskStatus: 1, startDate: new Date('02/03/2017'), endDate: new Date('02/07/2017'), duration: 5, progress: 100, priority: 'Normal', approved: false },
    {
        taskID: 6,
        taskStatus: 2,
        taskName: 'Design',
